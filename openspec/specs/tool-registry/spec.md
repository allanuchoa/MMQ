...
Database registration of the Curva Polinomial tool in the public.applications table with idempotent SQL setup script and RLS policy template for future tool-specific tables.
