...
- **THEN** the static calculator shell displays an error banner ("Não foi possível validar sua sessão. Verifique sua conexão e tente novamente.") with a reload button, in addition to the visible input shell
