...
-- ============================================================================
INSERT INTO public.applications (slug, name, url, icon, category, is_active)
VALUES ('curva-polinomial', 'Curva Polinomial', 'https://allanuchoa.github.io/MMQ/', 'function-square', 'Engineering', true)
