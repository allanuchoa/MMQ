...
Export fitted polynomial coefficients as an Excel-compatible formula string (decimal notation, never scientific), displayed in a dedicated UI box with one-click clipboard copy.
...
- **THEN** the Excel box becomes visible with the formula and label "Formula para Excel (copie e cole)"
